...
module.exports = {
	getAdminRoutes: function(tollan) {
		...
		return [
			<Route name="adminBlogPosts" key="adminBlogPosts" path="blog/posts" handler={require('./components/admin/posts')} />,
			<Route name="adminBlogTags" key="adminBlogTags" path="blog/tags" handler={require('./components/admin/tags')} />
		];
	},
